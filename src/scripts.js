...
let user = new User(usersData.users[Math.floor(Math.random() * usersData.users.length)]);
// Event listeners
...
export const displayCurrentUser = (user, data) => {
 ...
 export const displaySleepInfo = (sleep) => {
...
export const displayHydrationAvg = (userId) => {
